...
namespace FCG
{
    public class TrafficCar : MonoBehaviour
    {
        ...
        private Transform GetTransformWheel(string wheelName)
        {
            ...
            wt = FindObjectsByType<GameObject>(FindObjectsSortMode.None)
                .Where(g => g.name == wheelName && g.transform.root == transform)
                .ToArray();
        ...
        void Start()
        {
            ...
            if (player != null && FindFirstObjectByType<TrafficSystem>() == null)
                Debug.LogError("Traffic System prefab not found in the scene");
